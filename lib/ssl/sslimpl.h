...
extern PRBool ssl3_IsSupportedSignatureScheme(SignatureScheme scheme);
extern SECStatus ssl3_CheckSignatureSchemeConsistency(
    sslSocket *ss, SignatureScheme scheme, CERTCertificate *cert);
extern SECStatus ssl3_ConsumeSignatureScheme(
...
SSLSignType ssl3_SignTypeForKey(const SECKEYPublicKey *key);
SSLHashType ssl3_SignatureSchemeToHashType(SignatureScheme scheme);
