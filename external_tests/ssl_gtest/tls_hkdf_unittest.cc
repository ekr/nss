...
TEST_F(TlsHkdfTest, HkdfExpandLabelSha256) {
  const uint8_t expected[] = {
    0x31, 0xcf, 0x1e, 0xaf, 0x69, 0xbb, 0x79, 0x06,
    0x6c, 0x35, 0x84, 0x15, 0xca, 0xe3, 0xbe, 0x8f,
    0x98, 0xfe, 0x6d, 0x74, 0x57, 0xbd, 0x53, 0x27,
    0x21, 0xff, 0x6f, 0x57, 0xe6, 0x3f, 0x2f, 0xbd
  };
  const DataBuffer expected_data(expected, sizeof(expected));
